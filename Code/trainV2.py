...
BASE_OUTPUT_DIR = r'E:\DSUnet-drivable_area_segmentation\Data\Lane-Segmentation-Auto.v1i.png-mask-semantic' 
...
def get_mixed_dataset_paths(dir_path):
    ...
    Quy tắc match:
    - Ảnh: abc.jpg
    - Mask: abc_mask.png (Dựa trên mô tả của user)
    """
    ...
    for img_file in img_files:
        ...
        # Nếu không thấy mask thì bỏ qua ảnh này
